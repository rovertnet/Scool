                ...
                <div className="  md:px-10 px-9 md:p-6 p-3">
                  <div className="flex justify-between items-center">
                    ...
                    <div className="-mr-2 flex md:hidden p-3">
                      {/* Mobile menu button */}
                      <Disclosure.Button className="relative inline-flex items-center justify-center rounded-md bg-purple p-2 text-green-700 hover:bg-green-700 hover:text-white focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-green-700">
