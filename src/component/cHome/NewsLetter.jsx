  ...
  return (
    <>
      <div className="md:mx-10 mx-10 md:my-10 my-10">
        <div className="flex flex-col justify-start items-start gap-5 bg-green-700 md:px-10 px-10 md:py-12 py-10">
          ...
          <div className="flex space-x-3">
            <input
              ...
              className=" md:px-5 px-5 md:py-3 py-2 outline outline-0 focus:outline-0 w-full"
            />
            <button className="bg-black px-5 md:px-5 md:py-3 py-2 hover:bg-slate-900 text-lg font-bold text-slate-50">Souscrire</button>
          </div>
        </div>
      </div>
    </>
